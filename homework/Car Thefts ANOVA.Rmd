...
Data that stands out the most is that pre spike mean thefts and mean rate get doubled during the spike year and although they fall a little bit post-spike, they still stay at much higher statistics than pre spike.
...
- **Null Hypothesis (H0)**: No correlation between time period and theft rate.

- **Alternative Hypothesis (H1)**: Car theft rates went up drastically post pandemic.
...
ANSWER HERE
YES. definitely, the F value is legit 218. Very high, which means the between-group variance (or average rates between time periods) is substantially higher than the within-group variance. 
...
ANSWER HERE
Alright so p values are small for everything, which means the statistics are significant. The spike year has far higher differences than pre spike and post spike, but it is notable that post spike year still had noticably higher theft rates than pre spike as indicated in the "-20.1321" diff. The difference between pre and post is significant, even though it isn't crazily high, because the p value is 0 and the lwr and upr levels are 95% confidence and don't have 0. 

Making a headline and lede;
Post COVID car thefts remain higher than pre spike years, according to PG County data.

After 2021, PG County car thefts increased dramatically, more than doubling and continuing to rise. After this spike year theft rates have begun to drop but the county continues to maintain a car theft rate substantially higher than it was pre pandemic.
