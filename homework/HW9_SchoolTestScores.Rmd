...
Better since SD puts the previous lowest score at like 69, while the new lowest score is 73.
...
Already much higher. These statistics make me want to look for more evidence of correlation, is this just small sample size? Is it the same classrooms? And are there other factors contributing to such an increase in mean?
...
Test Scores after Reading Program Implemented
...
**Hypotheses:**
Null: The new reading program didn't impact student testing scores
Alternative: The new reading program increased student testing scores
...
headline: New reading program increases student reading test scores by 4.3%
lede: Statistics back Superintendent's claim that the new reading program has increased class testing scores. The previous average score of 72.6 has increased to 75.75 following its implementation.

### Reflection Question 6:
What metrics or outcomes beyond test scores might be important to track for assessing reading performance?
Time of year at school, current events regarding the local area, maybe things that could've previously hindered performance like not prepping students at all previously. 
