...
Rarely/never category shows biggest difference in weighted and unweighted.

2. How might these differences affect reporting on likely voter turnout?
They significantly can skew how the result of an election would've been, and pollsters have pretty much nothing to predict whether or not these groups of people will show up or not to vote so reporting gets it wrong. Like Dewey v Truman.
...
These differences exist because people are unpredictable and sometimes do things that they don't even expect themselves to do. And on the topic of voting always, sporadically, or barely it is hardest to measure the likelihood that people who barely vote will vote. So they will always be under represented or inaccurately represented in polls.
