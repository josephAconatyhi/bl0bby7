...
ANSWER HERE
Above 17 and below 5 is outliers. Unusual days are near the 0s and 17+. 
...
ANSWER HERE
They are pretty much what I was after, I was hesitant to say 20 and above but that woudl've been correct. The 5 and below wasn't right ... it should be like 2 calls and below. But honestly the range was kinda closer than I expected myself to get it.
```{r plot-unusual-days}
...
ANSWER HERE
I would call the day w the highest z score the day with the highest average number of drug OD calls out of the week. Kind of a mouthful but it's pretty straightforward.
...
ANSWER HERE
Perhaps an angle would be that drug dealers are lacing the drugs which would lead to more OD calls and more deaths. Also the time frame where overall OD calls are lower and higher has some sort of correlation to seasons - winter has a sharp drop in OD calls. March and past march (minus June) have high high high OD calls. 

Next steps are figuring out the why, going to Baltimore County and asking people from different demographics of age race and gender why these things are happening and taking what you find to the editor.
