...
Expected is more round, all even numbers in the 10s range (idk how to articulate this but they're all like multiples of 10). The observed frequency has more variation and is sometimes higher or lower than expected but the numbers look a little less like solid estimations and more like real possible outcomes.
...
ANSWER HERE
Yeah we reject the null hypothesis. Since the calculated value is greater than the critical value, we have to go with the alternative hypothesis that the movie reviews are different from what we expected them to be.
