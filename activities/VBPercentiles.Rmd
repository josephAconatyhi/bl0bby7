...
```{r}
team_aces |> mutate(percentil = ntile(total_aces, 100))
```
...
Well 95th percentile does sound a lot better than 17th in the nation. This specific stat makes Maryland look good but we apparently were getting stomped, but hey at least we were kinda insane at uh aces. C00l.
