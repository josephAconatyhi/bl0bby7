...
Like what we said in class a little bit, the data is encouraging but also can have holes in it. Narratives in media create a perception easy to adopt that the world is getting worse and bad things are happening more because that's one way to keep people on their phones, but it looks like violent crime and property crime rates were lower than it has been in recent years. But like we said there are caveats to this data, like what % of the population isn't reporting crimes that are happening and how much would that change the data currently. It's complicated because we don't have a tangible way to express this but it is a very real problem. Property crime was SO high in the 70s and 80s. Jesus bro. 
