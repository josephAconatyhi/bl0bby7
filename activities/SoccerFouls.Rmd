...
Ok so the coefficient is very very low, but not negative. That means the relationship isn't much of a relationship at all. 99% not a relationship between goal diff and fouls committed. The scatterplot shows a lot of points just here and there in a kind of normal distribution, nothing crazy to see. It kind of confirms these two things don't really contribute to the other. 
