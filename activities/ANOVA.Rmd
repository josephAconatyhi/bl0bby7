...
Minimum score for community college was very low at 786 while maximum score for both private and public was double that. The mean scores for private and public are close together as is the median, but the mean score for community is a couple hundred lower. This suggests that lower SAT scores have a relationship with community college (although the data was set up to portray that). 
...
For public and private compared to community, yes. For public compared to private, no.

2. Which specific college types differ from each other?
Private v Community and Public v Community differ from each other in how significantly they contrast. Public and private aren't completely the same but they are within close range of each other in terms of SAT scores.

3. How large are these differences?
Very large differences, less large between Public and Private at ~75 but high nonetheless for these scores. ~367 points higher for Private compared to community and ~293 higher for Public compared to community.
...
Data analysis shows private college SAT scores are 367 points higher than community college SAT scores. 

Using ANOVA tests and Tukey tests as well as college admission data, we have found that the difference in SAT scores between different colleges is high. Public and private colleges had hundreds of points higher on average than community college, and private had 70 points higher than public colleges.
