...
Looks like highest levels are Friday, Saturday, and Sunday while the lowest average are Monday - Thurssday. These patterns might exist because people tend to be more relaxed and less focused on weekends compared to weekdays on average. This translates into driving which creates more accidents on average during the weekend.
...
ANSWER HERE
October 29, 2021 - according to world-weather.info, Oct 29 2021 in Maryland had intensely heavy rain compared to pretty much every single other day, this could contribute to it having the by far highest z score for accidents.
...
ANSWER HERE
There's a lot more days of the week compared to weekends on an individual level for extreme day of week scores, while overall has a lot more Saturdays and Sundays. I could make an inference that the day of week scores aren't as representitive of general patterns and moreso outliers compared to extreme z scores overall. 
...
ANSWER HERE
Jan Feb and March are by far the lowest for avg accidents, peak of accidents is October and it stays highest in the winter months. This can be attributed to icy weather which happens more often in winter months and less often in spring months. 
...
ANSWER HERE
A LOT of friday saturday sundays in here. Also digits are either in the late 40s early 50s or the low single digits for accidents. 
...
Pitch: 
PG County accidents spike during weekends and winter months according to PG County Data. 

Using Z scores we found that accidents occur most in October and least in January, and that they tend to happen most often during Friday to Sunday. 

Sources I'd use are the Z scores for weekday and overall, people I'd talk to would be PG residents who drive in different demographics like age, race, and class background so that there are different voices in the story. 
